...
<div class="header bg-main">
  ...
  <div class="head-l"><a class="button button-little bg-green" href="personalInfo.html" target="right"><span class="icon-home"></span> 个人中心</a> &nbsp;&nbsp;
      <a href="modifyInfoE.html" target="right" class="button button-little bg-blue"><span class="icon-wrench"></span> 修改信息</a> &nbsp;&nbsp;
      <a href="announcementE.html" target="right" class="button button-little bg-green"><span class="icon-wrench"></span> 查看公告</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul style="display:block">
      <li><a href="personalInfo.html" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
      <li><a href="modifyInfoE.html" target="right"><span class="icon-caret-right"></span>修改信息</a></li>
    <li><a href="punchClock.html" target="right"><span class="icon-caret-right"></span>自我考勤</a></li>
    <li><a href="attendanceInfo.html" target="right"><span class="icon-caret-right"></span>考勤记录</a></li>

  </ul>   
  <h2><span class="icon-pencil-square-o"></span>操作</h2>
  <ul style="display: block;">
    ...
    <h2><span class="icon-reorder"></span>记录</h2>
    <ul style="display: block;">
    ...
    <h2><span class="icon-file-text"></span>意见</h2>
    <ul style="display: block;">
        <li><a href="overtimeTable.html" target="right"><span class="icon-caret-right"></span>意见反馈</a></li>
    </ul>
</div>
